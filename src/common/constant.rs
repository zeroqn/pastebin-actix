...
pub const _ERR_MSG_BAD_JSON_PAYLOAD: &str = "bad json payload";
pub const ERR_MSG_DATA_NOT_FOUND: &str = "data no found";
pub const ERR_MSG_DATABASE_OPEARTION_FAIL: &str = "database operation fail";
